      ...
      <div className="p-4 pb-2 space-y-4">
        ...
        <div className="flex justify-center gap-6 border-b border-border/25 pb-2 text-[11px] font-semibold text-muted">
          <button
            ...
            className={`cursor-pointer hover:text-text transition-colors capitalize ${activeTab === 'new' ? 'text-text border-b border-text -mb-[9px] pb-[7px]' : ''
              }`}
          >
            New
          </button>
          <button
            ...
            className={`cursor-pointer hover:text-text transition-colors capitalize ${activeTab === 'all' ? 'text-text border-b border-text -mb-[9px] pb-[7px]' : ''
              }`}
          >
            All
          </button>
        ...
        {filteredUsers.map((user) => {
          ...
          return (
            <button
              ...
              className={`w-full flex items-center gap-3 p-2 rounded-lg text-left cursor-pointer transition-all duration-150 ${isSelected
