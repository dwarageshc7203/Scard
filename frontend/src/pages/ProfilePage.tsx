    ...
    <div className="flex bg-gray-50 dark:bg-[#202020] text-gray-900 dark:text-gray-200 overflow-hidden" style={{ height: '100vh' }}>
      ...
      {isOwnProfile && (
        <aside className="w-[64px] h-full flex flex-col items-center py-6 border-r border-gray-200 dark:border-white/10 bg-white dark:bg-[#252525] shrink-0 relative z-[60]">
          <Image onClick={() => window.location.href = '/'} src={scardLogo} className="w-8 h-8 rounded-[8px] cursor-pointer hover:opacity-80 transition-opacity" alt="Scard Logo" />
          ...
          <div className="flex flex-col gap-10 flex-1 mt-12 justify-center">
            ...
            <div className="relative flex justify-center">
              ...
              {/* Menu Popover */}
              {activeOverlay === 'menu' && (
                <div className="absolute left-[50px] top-1/2 -translate-y-1/2 bg-white dark:bg-[#2A2A2A] border border-gray-200 dark:border-white/10 p-2 w-[160px] rounded-xl shadow-2xl flex flex-col gap-2 z-[70]">
