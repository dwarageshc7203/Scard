    ...
    <div className="min-h-screen bg-bg text-text flex flex-col items-center relative overflow-x-hidden selection:bg-accent/30 font-sans transition-colors duration-300 scroll-smooth">
      ...
      <header className="w-full px-8 py-6 flex justify-between items-center absolute top-0 left-0 z-50">
        ...
        <div className="flex items-center justify-center gap-2 flex-1">
          <img src="/logos/scard.png" alt="Scard" className="w-6 h-6 object-contain filter dark:invert-0 rounded-[5px]" />
          <span className="text-text font-semibold tracking-wide text-lg" style={{ fontFamily: "'Graphik', sans-serif" }}>Scard</span>
        </div>
        {/* Sign Up */}
      ...
      <main className="w-full flex-col flex items-center pt-[180px] pb-32 px-4 relative z-10">
        <motion.div style={{ y: yHeroText }} className="text-center leading-[1.1] relative">
          <h1 className="text-[60px] md:text-[100px] text-text font-normal" style={{ fontFamily: "'Playfair Display', serif" }}>
          ...
          <motion.div style={{ y: yCursor }} className="absolute -right-[20px] top-[120px] w-[140px] h-[140px]">
            <img src="/elements/cursor.png" alt="Cursor" className="w-full h-full object-contain" />
          </motion.div>
        </motion.div>
      </main>
      ...
      <section className="w-full flex flex-col items-center justify-center relative z-20 pb-32">
        <div className="flex flex-col items-center max-w-[900px] w-full">
          <h2 className="text-[32px] text-muted mb-6 self-start pl-8" style={{ fontFamily: "'Playfair Display', serif" }}>
            why <span className="text-red-500 dark:text-[#e24a4a]">multiple</span> profiles
          </h2>

          {/* Static ExportCard Image */}
          <motion.div style={{ y: yImage }} className="relative w-full flex justify-center drop-shadow-2xl overflow-hidden rounded-[24px]">
            <div className="scale-[0.8] origin-top md:scale-100 flex justify-center w-full px-4 md:px-0">
              <img src="/elements/scard-card-light.png" alt="Sample Profile Light" className="w-full max-w-[850px] h-auto object-contain rounded-2xl border border-border dark:hidden block" />
              <img src="/elements/scard-card-dark.png" alt="Sample Profile Dark" className="w-full max-w-[850px] h-auto object-contain rounded-2xl border border-border hidden dark:block" />
            </div>
          </motion.div>

          <h3 className="text-[32px] md:text-[40px] text-muted italic mt-6 self-end pr-8" style={{ fontFamily: "'Playfair Display', serif" }}>
            when it be presented <span className="text-[#d89e25] font-semibold">this good</span>
          </h3>
        </div>
      </section>
      ...
      <section className="w-full flex flex-col items-center justify-center pb-40 px-4">
        <h2 className="text-[40px] md:text-[48px] text-text text-center leading-tight mb-16 max-w-lg" style={{ fontFamily: "'Playfair Display', serif" }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-[800px] w-full">
          ...
          <div className="bg-surface-2 border border-border rounded-2xl p-8 flex flex-col items-center justify-center h-[240px] hover:brightness-110 transition-all drop-shadow-sm dark:drop-shadow-none">
            <h4 className="text-text text-[30px] mb-8" style={{ fontFamily: "'Playfair Display', serif" }}>Your contest ratings</h4>
            <div className="flex items-end gap-3 h-[60px]">
              <img src="/logos/codeforces.png" alt="Codeforces" className="w-10 h-10 object-contain mr-2 mb-1" />
          ...
          {/* Card 2 */}
          <div className="bg-surface-2 border border-border rounded-2xl p-8 flex flex-col items-center justify-center h-[240px] hover:brightness-110 transition-all drop-shadow-sm dark:drop-shadow-none">
            <h4 className="text-text text-[30px] mb-8" style={{ fontFamily: "'Playfair Display', serif" }}>Your contributions</h4>
            <div className="flex items-end gap-3 h-[60px]">
              <img src="/logos/github.png" alt="GitHub" className="w-11 h-11 object-contain mr-1 mb-1 dark:invert" />
              <div className="w-4 h-full bg-[#d89e25] rounded-t-sm"></div>
          ...
          {/* Card 3 */}
          <div className="bg-surface-2 border border-border rounded-2xl p-8 flex flex-col items-center justify-center h-[240px] hover:brightness-110 transition-all drop-shadow-sm dark:drop-shadow-none">
            <h4 className="text-text text-[30px] mb-8" style={{ fontFamily: "'Playfair Display', serif" }}>Your projects</h4>
            <div className="flex items-center justify-center h-[60px]">
              <img src="/logos/github.png" alt="GitHub" className="w-[70px] h-[70px] object-contain opacity-90 dark:invert" />
            </div>
          </div>

          {/* Card 4 */}
          <div className="bg-surface-2 border border-border rounded-2xl p-8 flex flex-col items-center justify-center h-[240px] hover:brightness-110 transition-all drop-shadow-sm dark:drop-shadow-none">
            <h4 className="text-text text-[30px] mb-8" style={{ fontFamily: "'Playfair Display', serif" }}>Your badges</h4>
            <div className="flex items-center justify-center h-[60px]">
              <img src="/logos/leetcode.png" alt="LeetCode" className="w-[60px] h-[60px] object-contain drop-shadow-lg" />
            </div>
          </div>
      ...
      <section className="w-full flex flex-col items-center justify-center pb-32 px-4 text-center">
        <h3 className="text-[24px] md:text-[28px] text-[#d89e25] italic mb-4" style={{ fontFamily: "'Playfair Display', serif" }}>
          why scroll this long?
        </h3>
        <h2 className="text-[44px] md:text-[56px] text-text font-normal" style={{ fontFamily: "'Playfair Display', serif" }}>
          See it yourself!
        </h2>
      </section>
      ...
      <footer className="w-full py-16 px-8 grid grid-cols-1 md:grid-cols-2 gap-12 bg-surface border-t border-border z-20">
        <div className="flex flex-col items-center md:items-end justify-center gap-8 border-r-0 md:border-r border-border pr-0 md:pr-12 md:-translate-x-30">
          <div className="flex items-center gap-4">
            <img src="/logos/scard.png" alt="Scard" className="w-16 h-16 object-contain rounded-[5px]" />
            <span className="text-text font-semibold tracking-wide text-5xl" style={{ fontFamily: "'Graphik', sans-serif" }}>Scard</span>
          </div>
          <button
            onClick={() => window.location.href = '/oauth2/authorization/google'}
        ...
        <div className="flex flex-col items-center md:items-start justify-start pt-2 pl-0 md:pl-12 gap-6 text-center md:text-left">
          <h4 className="text-text text-2xl" style={{ fontFamily: "'Playfair Display', serif" }}>
            Contact the creator
          </h4>
